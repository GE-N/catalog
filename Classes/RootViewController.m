...
- (void)insertNewObject {
    ...
    ManageCategoriesVC *newCategory = [[ManageCategoriesVC alloc] initWithNibName:@"ManageCategoriesVC"
																		   bundle:nil];
	...
	newCategory.entity = entity;
	

	
	[self.navigationController pushViewController:newCategory animated:YES];
}
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    */
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Catalog" inManagedObjectContext:managedObjectContext];
